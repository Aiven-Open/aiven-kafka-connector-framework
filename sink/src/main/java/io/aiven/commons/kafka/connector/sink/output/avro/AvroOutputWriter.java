...
package io.aiven.commons.kafka.connector.sink.output.avro;
...
public final class AvroOutputWriter extends OutputWriter {
    ...
    /**
     * An instance of SinkOutputStreamWriter that handles writing the Avro format
     */
    private static final class AvroOutputStreamWriter implements SinkOutputStreamWriter {
        private final static String NAMESPACE = "io.aiven.avro.output.schema";
        /**
        ...
        AvroOutputStreamWriter(final Collection<OutputField> fields, final Map<String, String> externalConfig,
            ...
            this.avroSchemaBuilder = new AvroSchemaBuilder(NAMESPACE, fields, avroData, envelopeEnabled);
