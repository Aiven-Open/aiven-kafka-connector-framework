...
public final class TemplateValidator implements ConfigDef.Validator {
  ...
  /**
   * Creates a TemplateValidator that will, at a minimum, validate that the format of the template
   * is correct. If the {@code registry} is provided additional checking for permitted variable
   * names, parameter names and validation of parameter values will be attempted. If {@code
   * registry} is {@code null} then all variable names will be accepted and no validation of
   * parameters will be performed.
   *
   * @param registry the registry validation information.
   */
