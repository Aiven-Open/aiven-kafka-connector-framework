...
public class VariableTemplatePart implements TemplatePart {
	...
	VariableTemplatePart(final String variableName, final Parameter parameter, final String originalPlaceholder) {
	 ...
	 * 
	 * @return the associated parameter. Will return {@link Parameter#EMPTY} if
	...
	/**
	 * Returns the original placeholder for the template. This is the variable
	 * pattern with the enclosing curly braces.
	 * 
