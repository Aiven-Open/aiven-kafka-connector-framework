...
public class ConnectorCommonConfig extends CommonConfig {
  ...
  /**
   * Returns {@code true} if the schema registry is enabled. Schema registry will not be listed as
   * enabled if the URL is null.
   *
  ...
  /**
   * Gets the value converter schema registry URL. May return {@code null} if not set.
   *
  ...
  /**
   * Returns {@code true} if the value converter schema registry is enabled. Schema registry will
   * not be listed as enabled if the value converter schema registry URL is null.
   *
   * @return {@code true} if the value converter registry is enabled, {@code false} otherwise.
   */
  ...
  /**
   * Gets the key converter schema registry URL. May return {@code null} if not set.
   *
  ...
  /**
   * Returns {@code true} if the key converter schema registry is enabled. Schema registry will not
   * be listed as enabled if the key converter schema registry URL is null.
   *
   * @return {@code true} if the key converter registry is enabled, {@code false} otherwise.
   */
