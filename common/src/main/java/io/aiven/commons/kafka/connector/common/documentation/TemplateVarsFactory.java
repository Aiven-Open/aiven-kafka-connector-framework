...
public class TemplateVarsFactory {
  ...
  /**
   * Constructs the TemplateVariableRegistry for the named class that will create an instance of
   * TemplateVariableRegistry.
   *
   * @param className the class that is a supplier of the TemplateVariableRegistry instance.
   * @return a TemplateVariableRegistry instance..
   */
  public TemplateVariableRegistry registry(String className) {
    try {
      final Class<Supplier<TemplateVariableRegistry>> clazz =
          (Class<Supplier<TemplateVariableRegistry>>) Utils.loadClass(className, Supplier.class);
