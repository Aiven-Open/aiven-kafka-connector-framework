...
public class TransformerInfoTest {
	...
	@ParameterizedTest
	@CsvSource({"no features, 0, false, false, false", "feat1, 1, true, false, false", "feat2, 2, false, true, false",
			"feat3, 3, true, true, false", "feat4, 4, false, false, false", "private, 16777216, false, false, true",
	...
	public void anyFeatures(String name, int flag, boolean f1, boolean f2, boolean f3) {
		...
		assertThat(underTest.anyFeatures(FEATURE1 | PRIVATE_FEATURE1)).as("f1 private").isEqualTo(f1 || f3);
		assertThat(underTest.anyFeatures(FEATURE2 | PRIVATE_FEATURE1)).as("f2 private").isEqualTo(f2 || f3);
		assertThat(underTest.anyFeatures(FEATURE1 | FEATURE2 | PRIVATE_FEATURE1)).as("f1 f2 private")
				.isEqualTo(f1 || f2 || f3);
	}
	...
	public void allFeatures(String name, int flag, boolean f1, boolean f2, boolean f3) {
		...
		assertThat(underTest.allFeatures(FEATURE1 | PRIVATE_FEATURE1)).as("f1 private").isEqualTo(f1 && f3);
		assertThat(underTest.allFeatures(FEATURE2 | PRIVATE_FEATURE1)).as("f2 private").isEqualTo(f2 && f3);
		assertThat(underTest.allFeatures(FEATURE1 | FEATURE2 | PRIVATE_FEATURE1)).as("f1 f2 private")
				.isEqualTo(f1 && f2 && f3);
	}
