...
public class TransformerInfoTest {
    ...
    @ParameterizedTest
    @CsvSource({"no features, 0, false, false, false",
    ...
    public void anyFeatures(String name, int flag, boolean f1, boolean f2, boolean f3) {
        ...
        assertThat(underTest.anyFeatures(FEATURE1 | FEATURE2 | PRIVATE_FEATURE1)).as("f1 f2 private").isEqualTo( f1 || f2 || f3);
    }
    ...
    public void allFeatures(String name, int flag, boolean f1, boolean f2, boolean f3) {
        ...
        assertThat(underTest.allFeatures(FEATURE1 | FEATURE2 | PRIVATE_FEATURE1)).as("f1 f2 private").isEqualTo( f1 && f2 && f3);
    }

    @ParameterizedTest
    @CsvSource({"no features, 0",
            "feat1, 1",
            "feat2, 2",
            "feat3, 3",
            "feat4, 4",
