...
// */
// protected abstract I getSourceRecordIterator(Map<String, String> configData,
...
// .connector(getConnectorClass()).maxTasks(maxTasks);
...
// expectedKeys.add(write(topic, testData1.getBytes(StandardCharsets.UTF_8),
/// 0).getNativeKey());
...
// final AbstractSourceRecord<K, ?, O, ?> sourceRecord =
/// sourceRecordIterator.next();
...
// final int taskId = 0;
//
// final Map<String, String> configData = createConfig(topic, taskId, maxTasks,
/// InputFormat.AVRO);
...
// final List<Long> lst = v == null ? new ArrayList<>() : v; // NOPMD new object
/// inside loop
...
// assertThat(seen).as("Count for " +
/// key).containsExactlyInAnyOrderElementsOf(expected);
// }
// }
//
// /**
// * Test the iterator can detect rehydration. Rehydration is when additional
/// data
// * items are written to the data store after the iterator has reported
// * exhaustion. The iterator must be able to detect the new records ana process
// * them.
// */
// @Test
...
// // create 2 files.
// final var topic = getTopic();
// final Map<String, String> configData = createConfig(topic, 0, 1,
/// InputFormat.BYTES);
//
// final String testData1 = "Hello, Kafka Connect S3 Source! object 1";
// final String testData2 = "Hello, Kafka Connect S3 Source! object 2";
...
// assertThat(sourceRecordIterator).as("Reloading leads to extra
/// entries").isExhausted();
