...
public class TransformerRegistryTest {
    ...
    void getIgnoreCase() {
        ...
        TransformerRegistry registry2 = TransformerRegistry.builder().add(underTest).add(new TransformerInfo("no features", Transformer.class, TransformerInfo.FEATURE_NONE)).build();
    ...
    @Test
    void anyFeature() {
        assertThat(underTest.anyFeature(FEATURE1).stream().map(TransformerInfo::commonName).toList()).containsExactlyInAnyOrder("feat1", "feat3", "private + 1", "private + 3");
        assertThat(underTest.anyFeature(FEATURE2).stream().map(TransformerInfo::commonName).toList()).containsExactlyInAnyOrder("feat2", "feat3", "private + 2", "private + 3");
        assertThat(underTest.anyFeature(PRIVATE_FEATURE1).stream().map(TransformerInfo::commonName).toList()).containsExactlyInAnyOrder("private", "private + 1", "private + 2", "private + 3", "private + 4");
        assertThat(underTest.anyFeature(FEATURE1 | FEATURE2).stream().map(TransformerInfo::commonName).toList()).containsExactlyInAnyOrder("feat1", "feat2",  "feat3", "private + 1", "private + 2", "private + 3");
    }

    @Test
    void allFeatures() {
        assertThat(underTest.allFeatures(FEATURE1).stream().map(TransformerInfo::commonName).toList()).containsExactlyInAnyOrder("feat1", "feat3", "private + 1", "private + 3");
        assertThat(underTest.allFeatures(FEATURE2).stream().map(TransformerInfo::commonName).toList()).containsExactlyInAnyOrder("feat2", "feat3", "private + 2", "private + 3");
        assertThat(underTest.allFeatures(PRIVATE_FEATURE1).stream().map(TransformerInfo::commonName).toList()).containsExactlyInAnyOrder("private", "private + 1", "private + 2", "private + 3", "private + 4");
        assertThat(underTest.allFeatures(FEATURE1 | FEATURE2).stream().map(TransformerInfo::commonName).toList()).containsExactlyInAnyOrder("feat3", "private + 3");
    }
