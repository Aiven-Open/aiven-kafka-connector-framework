...
public final class AvroTestDataFixture {
	...
	/**
	 * The schema used when testing plain data without envelope. Created from
	 * {@link #CONNECT_EXTRA_SCHEMA_JSON}.
	 */
	public static final Schema CONNECT_EXTRA_SCHEMA = new Schema.Parser().parse(CONNECT_EXTRA_SCHEMA_JSON);

	/**
	 * The schema used to test the evolution of schema. Created from
	 * {@link #EVOLVED_SCHEMA_JSON}.
	 */
	...
	/**
	 * Generate an avro record with the specified message id using the default
	 * schema.
	 *
	 * @param messageId
	 *            the message id.
	...
	/**
	 * Generate an avro record with the specified message id using the specified
	 * schema
	 *
	 * @param messageId
	 *            the message id.
