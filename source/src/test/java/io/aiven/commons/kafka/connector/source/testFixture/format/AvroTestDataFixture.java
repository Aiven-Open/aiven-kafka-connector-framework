...
public final class AvroTestDataFixture {
  ...
  /**
   * The schema used when testing plain data without envelope. Created from {@link
   * #CONNECT_EXTRA_SCHEMA_JSON}.
   */
  public static final Schema CONNECT_EXTRA_SCHEMA =
      new Schema.Parser().parse(CONNECT_EXTRA_SCHEMA_JSON);
  ...
  public static List<GenericRecord> generateAvroRecords(
      final int numRecs, final Function<Integer, GenericRecord> recordCreator) {
