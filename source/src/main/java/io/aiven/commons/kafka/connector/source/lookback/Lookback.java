...
public interface Lookback<K extends Comparable<K>> {
	...
	/**
	 * Resize the lookback. May resize this lookback or create new one. The
	 * resulting lookback will contain as much of the latest data from this lookback
	 * as possible in the new configuration.
	 * 
	 * @param size
	 *            the desired size of the lookback.
	 * @return a Lookback of the desired size.
	 */
