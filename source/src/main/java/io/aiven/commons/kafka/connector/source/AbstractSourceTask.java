...
public abstract class AbstractSourceTask extends SourceTask {
	...
	public final void start(final Map<String, String> props) {
		...
		Iterator<EvolvingSourceRecord> esrIter = IteratorUtils.transformedIterator(getIterator(config),
				this::lastEvolution);
		final Iterator<SourceRecord> inner = IteratorUtils.transformedIterator(esrIter,
	 ...
	 * This method is called just before the EvolvingSourceRecord is converted into
	 * a SourceRecord. This is the last point to modify
	 * <ul>
