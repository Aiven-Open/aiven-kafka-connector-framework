...
/**
 * A registry of transformers. TransformerRegistry instances are immutable. Use the builder to
...
public class TransformerRegistry {
  ...
  public static final TransformerRegistry STANDARD =
      new Builder()
          .add(AvroTransformer.info())
          .add(ByteArrayTransformer.info())
          .add(CsvTransformer.info())
          .add(JsonTransformer.info())
          .add(ParquetTransformer.info())
          .build();
   ...
   *
   * @param transformers the map of names to transformers.
   */
  ...
  /**
   * Gets a TransformerInfo for the specific name. The TransformerInfo with the first matching name
   ...
   *
   * @return one of the transformers or {@code null} if no transformers are present.
   */
  ...
  public static class Builder {
     ...
     *
     * @param infos the TransformerInfo records to add.
     * @return this
     */
    ...
    /**
     * Adds all the transformers from a registry to the builder. Any existing TransformersInfos with
