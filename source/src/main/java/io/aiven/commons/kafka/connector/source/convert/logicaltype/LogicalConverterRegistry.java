...
public class LogicalConverterRegistry {
	 ...
	 *            the logical type name to register.
	 * @param converter
	 *            the converter for the name. May not be {@code null}.
	 */
	...
	/**
	 * Unregisters (removes) the logical type name if it was previously registered.
	 * After an {@code unregister} call the result of
	 * {@link #isRegisteredLogicalType(String)} is guaranteed to be false.
	 *
	 * @param logicalTypeName
	 *            the logical type name to unregister.
	 */
	 ...
	 *
	 * @param logicalTypeName
	 *            the logical type name. May be {@code null}.
	 * @return the LogicalTypeConverter or {@code null} if none is registered or
	 *         {@code null} passed for {@code logicalTypeName}.
	 */
	 ...
	 * @return {@code true} if there is a converter registered, {@code false}
	 *         otherwise.
	 */
