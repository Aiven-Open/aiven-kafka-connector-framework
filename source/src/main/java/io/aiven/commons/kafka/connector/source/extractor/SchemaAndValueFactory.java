...
public final class SchemaAndValueFactory {
   ...
   *
   * @param object the Object to generate the schema and value for.
  ...
  /** A class that processes objects recursively to produce a schema and a Jason object. */
    ...
    public void accept(String s, Object o) {
      if (o == null) {
        ...
        if (o instanceof Byte) {
          ...
          schemaBuilder.field(
              s, SchemaBuilder.struct().name("BigDecimal").field("value", Schema.STRING_SCHEMA));
          root.set(s, root.objectNode().put("value", bd.toString()));
        } else if (o instanceof BigInteger bi) {
          schemaBuilder.field(
              s, SchemaBuilder.struct().name("BigInteger").field("value", Schema.STRING_SCHEMA));
        ...
        schemaBuilder.field(
            ...
            SchemaBuilder.struct()
                .name("Object")
                .field("class", Schema.STRING_SCHEMA)
                .field("json", Schema.STRING_SCHEMA));
        root.set(
            s,
            root.objectNode()
                .put("class", o.getClass().getCanonicalName())
                .put("json", generator.generateSchema(o.getClass()).toPrettyString()));
      }
    }
  }
}
