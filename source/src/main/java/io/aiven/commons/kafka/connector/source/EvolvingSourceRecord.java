...
final public class EvolvingSourceRecord {
	...
	/**
	 * Copy constructor for an abstract source record. This constructor makes a copy
	 * of the OffsetManagerEntry.
	 *
	 * @param sourceRecord
	...
	/**
	 * Gets the record count as recorded by the OffsetManager for the native item
